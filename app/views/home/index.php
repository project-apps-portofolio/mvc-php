...
<main class="wrapper" id="dynamic_content">
</main>
<script>
    $(document).ready(function() {
        ...
        function load_content() {
            var url = 'http://192.168.0.94:9000/api/order';
            $.ajax({
                url: url,
                method: "GET",
                // data: {
                ...
                success: function(data) {
                    ...
                    result.forEach(res => {
                        console.log(res);
                        var output = '<section class="breweries1" id="breweries1">\
                                        <ul>\
                                            <li>\
                                                <figure>\
                                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ5a5uCP-n4teeW2SApcIqUrcQApev8ZVCJkA&usqp=CAU" alt="">\
                                                    <figcaption>\
                                                        <h3></h3>\
                                                    </figcaption>\
                                                </figure>\
